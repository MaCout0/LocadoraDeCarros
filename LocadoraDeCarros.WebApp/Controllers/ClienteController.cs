...
public class ClienteController : WebControllerBase
    {
        ...
        public IActionResult Editar(EditarClienteViewModel editarVm)
        {
            ...
            var clienteAtualizado = mapeador.Map<Cliente>(editarVm);

            var resultado = servico.Editar(clienteAtualizado);
            ...
            ApresentarMensagemSucesso($"O registro ID [{clienteAtualizado.Id}] foi editado com sucesso!");
